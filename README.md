...
The **Museum With No Frontiers — Landscapes** gallery, built from the published
dataset `@museumwnf/landscapes-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/landscapes-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/landscapes/> through the reusable workflows in
