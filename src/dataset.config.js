...
export default {
  ...
  home: {
    title: 'landscapes.identity.title',
    intro: 'landscapes.home.intro',
    cards: [
      {
        title: 'landscapes.nav.catalogue',
        description: 'landscapes.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'landscapes.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'landscapes.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'landscapes.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'landscapes.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'landscapes.partnerObjects.emptyPartner',
  //         emptyInstitution: 'landscapes.partnerObjects.emptyInstitution',
  //         institutionSummary: 'landscapes.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'landscapes.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'landscapes.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
