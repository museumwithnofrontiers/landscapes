...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/landscapes-data`
  // carries in `manifest.projects` (checked 2026-09-19, landscapes-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/landscapes' },
