...
// `useGalleryData.js` used to be byte-identical local copies of what landscapes
...
// legacy project key, no UUID — landscapes shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (landscapes-data 1.0.11+), an outside
